...
internal class Day22Test : AocTest(Day22::class, loadExample = false) {
    ...
    fun `can deal into new stack`() {
        subject as Day22
        subject.naiveOneLine("deal into new stack", 0..9) shouldBe
    ...
    fun `can cut 3`() {
        subject as Day22
        subject.naiveOneLine("cut 3", 0..9) shouldBe
    ...
    fun `can cut -4`() {
        subject as Day22
        subject.naiveOneLine("cut -4", 0..9) shouldBe
    ...
    fun `can deal with increment p`() {
        subject as Day22
        subject.naiveOneLine("deal with increment 3", 0..9) shouldBe
                listOf(0, 7, 4, 1, 8, 5, 2, 9, 6, 3)
    }

    @Test
    fun `examples year 2019 day 22 part 1`() {
        Day22(loadExample(2019, "22a")).naiveShuffler(0..9) shouldBe listOf(0, 3, 6, 9, 2, 5, 8, 1, 4, 7)
        Day22(loadExample(2019, "22b")).naiveShuffler(0..9) shouldBe listOf(3, 0, 7, 4, 1, 8, 5, 2, 9, 6)
